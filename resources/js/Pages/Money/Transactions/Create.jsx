...
export default function TransactionsCreate({ accounts, type }) {
    ...
    return (
        <SectionLayout sectionName="Money">
            <Head title={`Add Transaction - ${data.flow_type === 'income' ? 'Income' : data.flow_type === 'expense' ? 'Expense' : 'Transfer'}`} />
