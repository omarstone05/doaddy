...
export default function ExpensesCreate({ accounts }) {
        ...
        <SectionLayout sectionName="Money">
            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-6">
                    ...
                    <p className="text-gray-500 mt-1">Add a new expense transaction</p>
                </div>
                                ...
                                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-teal-400 transition-colors">
                                    <div className="space-y-1 text-center">
                                        ...
                                        <div className="flex text-sm text-gray-600">
                                            <label htmlFor="attachments" className="relative cursor-pointer bg-white rounded-md font-medium text-teal-600 hover:text-teal-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-teal-500">
