...
export default function NotFound() {
    return (
        <>
            <Head title="Page Not Found - Addy" />
                ...
                <div className="relative z-10 max-w-lg w-full text-center">
                    <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-10 space-y-6">
                        ...
                        <div className="flex justify-center">
                            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 shadow-lg flex items-center justify-center">
                        ...
                        {/* Message */}
                        <div>
                            <h2 className="text-2xl font-semibold text-teal-800 mb-2">Page Not Found</h2>
