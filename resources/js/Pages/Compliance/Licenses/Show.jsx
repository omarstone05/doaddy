...
import { ArrowLeft, Edit, Award, Calendar, User, Tag, AlertTriangle, CheckCircle } from 'lucide-react';

export default function LicensesShow({ license }) {
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 mt-1">License #: {license.license_number}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            <span className={`px-3 py-1 text-sm font-medium rounded-full ${getStatusBadge(license.status)}`}>
                                {license.status.charAt(0).toUpperCase() + license.status.slice(1).replace('_', ' ')}
                            </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <p className="text-gray-900">{license.category || '-'}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-900">{license.issuing_authority || '-'}</p>
                        </div>
                        ...
                        {license.renewal_date && (
                            <div>
                                ...
                                <p className="text-gray-900">
                                    {new Date(license.renewal_date).toLocaleDateString('en-US', { 
                                        year: 'numeric', 
                                        month: 'long', 
                                        day: 'numeric' 
                                    })}
                        ...
                        {license.created_by && (
                            <div>
                                ...
                                <p className="text-gray-900">{license.created_by.name || '-'}</p>
                            </div>
                        )}
                    </div>
