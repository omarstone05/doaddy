...
export default function CertificatesEdit({ certificate }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/compliance/certificates/${certificate.id}`);
    };
        ...
        <SectionLayout sectionName="Compliance">
            ...
            <div className="max-w-3xl mx-auto ">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h1 className="text-2xl font-bold text-gray-900 mb-6">Edit Certificate</h1>
