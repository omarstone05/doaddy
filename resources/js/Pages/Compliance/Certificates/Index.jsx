...
import { Plus, Edit, Trash2, AlertTriangle, Calendar, Award, Eye } from 'lucide-react';
                                    ...
                                    <tr key={certificate.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <Link href={`/compliance/certificates/${certificate.id}`}>
                                                    <button className="text-gray-400 hover:text-teal-600" title="View">
                                                        <Eye className="h-4 w-4" />
                                                    </button>
                                                </Link>
                                                <Link href={`/compliance/certificates/${certificate.id}/edit`}>
                                                    <button className="text-gray-400 hover:text-teal-600" title="Edit">
