...
export default function InkConfigsCreate() {
    ...
    return (
        <PrintShopLayout>
            <Head title="Add Ink Configuration" />
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 className="text-2xl font-black text-gray-900 tracking-tight">Add Ink Configuration</h2>
                    <p className="text-gray-500 mt-1">Configure a new ink set</p>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g., Standard Ink Set (4 Bottles)"
                                    />
                        ...
                        <div className="bg-white/90 backdrop-blur-sm rounded-2xl border border-gray-200/50 p-6">
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"
                                placeholder="Additional notes about this ink configuration..."
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white/90 backdrop-blur-sm rounded-2xl border border-gray-200/50 p-6">
                            ...
                            >
                                ...
                                {processing ? 'Saving...' : 'Save Ink Config'}
                            </Button>
                            <Link
                                href="/print-shop/ink-configs"
