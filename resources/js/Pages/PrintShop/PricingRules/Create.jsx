...
export default function PricingRulesCreate({ materials, markupTypes }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post('/print-shop/pricing-rules');
    };

    return (
        <PrintShopLayout>
            <Head title="Add Pricing Rule" />
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 className="text-2xl font-black text-gray-900 tracking-tight">Add Pricing Rule</h2>
                    <p className="text-gray-500 mt-1">Define a new markup rule</p>
                </div>
            </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g., Standard Pricing (K150/sqm)"
                                    />
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-gray-500">Leave empty to apply to all materials</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    {errors.markup_type && <p className="mt-1 text-sm text-red-500">{errors.markup_type}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"
                                        placeholder={data.markup_type === 'percentage' ? '100' : '150.00'}
                                    />
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl p-6 text-white">
                            <h3 className="text-lg font-bold mb-4">Markup Types</h3>
                            <div className="space-y-4 text-sm">
                                <div className="bg-white/10 rounded-xl p-4">
                                    <p className="font-bold">Fixed Price per Sqm</p>
                                    <p className="text-white/80 mt-1">Set a fixed price regardless of cost (e.g., K150/sqm)</p>
                                </div>
                                <div className="bg-white/10 rounded-xl p-4">
                                    <p className="font-bold">Percentage Markup</p>
                                    <p className="text-white/80 mt-1">Add a percentage to the cost (e.g., 100% = double)</p>
                                </div>
                                <div className="bg-white/10 rounded-xl p-4">
                                    <p className="font-bold">Fixed Amount Markup</p>
                                    <p className="text-white/80 mt-1">Add a fixed amount per sqm to cost</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/90 backdrop-blur-sm rounded-2xl border border-gray-200/50 p-6">
                            ...
                            >
                                ...
                                {processing ? 'Saving...' : 'Save Pricing Rule'}
                            </Button>
                            <Link
                                href="/print-shop/pricing-rules"
