...
export default function Create({ auth, project, users = [] }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('consulting.projects.tasks.store', project.id));
    };
        ...
        >
            ...
            <div className="py-6">
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white/70 backdrop-blur-lg border border-white/20 rounded-xl p-6 mb-6">
                        <h3 className="text-lg font-semibold text-gray-900 mb-2">{project.name}</h3>
                        {project.code && <p className="text-sm text-gray-500">#{project.code}</p>}
                    </div>
