...
export default function AccountsEdit({ account, accountTypes, parentAccounts }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        allows_postings: account.allows_postings ?? true,
    ...
    const submit = (e) => {
        ...
        put(`/accounting/accounts/${account.id}`, {
            preserveScroll: true,
            onSuccess: () => {
                router.visit(`/accounting/accounts/${account.id}`);
            },
        });
    };
        ...
        <SectionLayout sectionName="Accounting">
            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-6">
                    <Button
                        variant="ghost"
                        onClick={() => router.visit(`/accounting/accounts/${account.id}`)}
                        className="mb-4"
                    >
