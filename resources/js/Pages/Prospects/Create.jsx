...
export default function ProspectsCreate({ organizationCurrency }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        estimated_value: '',
        probability: '',
        currency: organizationCurrency || 'ZMW',
    });
        ...
        <SectionLayout sectionName="Sales">
            ...
            <div className="max-w-2xl mx-auto">
                <div className="mb-6">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">Create Prospect</h1>
                    <p className="text-gray-500 mt-1">Add a new prospect to your sales pipeline</p>
                </div>
