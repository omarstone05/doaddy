...
export default function QuotesEdit({ quote, customers: initialCustomers, products: initialProducts }) {
    ...
    const submit = (e) => {
        ...
        router.put(`/quotes/${quote.id}`, data, {
            preserveScroll: true,
            onError: (errors) => {
    ...
    const canEdit = !quote?.invoice_id; // Can't edit if converted to invoice
                ...
                {!canEdit && (
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                        <p className="text-yellow-800">
                            This quote cannot be edited because it has been converted to an invoice.
                        </p>
                    </div>
                )}
