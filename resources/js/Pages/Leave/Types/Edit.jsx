...
export default function LeaveTypesEdit({ leaveType }) {
    const { data, setData, put, processing, errors } = useForm({
        name: leaveType.name || '',
        description: leaveType.description || '',
        maximum_days_per_year: leaveType.maximum_days_per_year || 0,
        can_carry_forward: leaveType.can_carry_forward || false,
        max_carry_forward_days: leaveType.max_carry_forward_days || null,
        ...
        <SectionLayout sectionName="People">
            ...
            <div className="max-w-3xl mx-auto ">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h1 className="text-2xl font-bold text-gray-900 mb-6">Edit Leave Type</h1>
