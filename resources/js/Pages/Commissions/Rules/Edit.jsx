...
export default function CommissionRulesEdit({ commissionRule, teamMembers, departments }) {
    const { data, setData, put, processing, errors } = useForm({
        name: commissionRule.name || '',
        description: commissionRule.description || '',
        rule_type: commissionRule.rule_type || 'percentage',
        rate: commissionRule.rate || '',
        fixed_amount: commissionRule.fixed_amount || '',
        tiers: commissionRule.tiers || [],
        applicable_to: commissionRule.applicable_to || 'all',
        team_member_id: commissionRule.team_member_id || '',
        department_id: commissionRule.department_id || '',
        is_active: commissionRule.is_active !== undefined ? commissionRule.is_active : true,
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/commissions/rules/${commissionRule.id}`);
    };

    return (
        <SectionLayout sectionName="People">
            <Head title="Edit Commission Rule" />
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h1 className="text-2xl font-bold text-gray-900 mb-6">Edit Commission Rule</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex gap-3 pt-4">
                            ...
                            <Button type="submit" disabled={processing}>
                                {processing ? 'Updating...' : 'Update Commission Rule'}
                            </Button>
                        </div>
                    </form>
                </div>
