...
export function AddyProvider({ children }) {
    ...
    const openAddy = (view = 'chat') => {
        console.log('openAddy called with view:', view);
        setPanelView(view);
        setIsOpen(true);
    ...
    const dismissInsight = async (insightId) => {
        try {
            const response = await window.axios.post(`/api/addy/insights/${insightId}/dismiss`);
    ...
    const completeInsight = async (insightId) => {
        try {
            const response = await window.axios.post(`/api/addy/insights/${insightId}/complete`);
            if (response.data.success) {
    ...
    const refreshInsights = async () => {
        try {
            const response = await window.axios.post('/api/addy/insights/refresh');
