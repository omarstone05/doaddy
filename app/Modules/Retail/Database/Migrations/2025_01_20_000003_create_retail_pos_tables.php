...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('retail_locations')) {
        ...
        // Customers
        if (!Schema::hasTable('retail_customers')) {
        ...
        if (!Schema::hasTable('retail_shifts')) {
        ...
        // Sale Items
        if (!Schema::hasTable('retail_sale_items')) {
        ...
        // Cash Movements
        if (!Schema::hasTable('retail_cash_movements')) {
        ...
        // Stock Adjustments
        if (!Schema::hasTable('retail_stock_adjustments')) {
        ...
        if (!Schema::hasTable('retail_stock_adjustment_items')) {
