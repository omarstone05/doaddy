...
class DepartmentController extends Controller
{
    ...
    {
        $query = Department::where('organization_id', $this->getOrganizationId());
    ...
    {
        $teamMembers = TeamMember::where('organization_id', $this->getOrganizationId())
    ...
    {
        $department = Department::where('organization_id', $this->getOrganizationId())
