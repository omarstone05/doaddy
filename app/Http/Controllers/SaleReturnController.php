...
class SaleReturnController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Get team member
            $teamMember = \App\Models\TeamMember::where('organization_id', Auth::user()->organization_id)
            ...
            return redirect()->route('sale-returns.show', $return->id)->with('message', 'Return processed successfully');
        } catch (\Exception $e) {
            DB::rollBack();
