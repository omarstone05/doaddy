...
class RegisterSessionController extends Controller
{
    ...
    public function open(Request $request)
    {
        ...
        return redirect()->route('register.index')->with('message', 'Register session opened successfully');
    }
    ...
    public function close(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('register.index')->with('message', 'Register session closed successfully');
        } catch (\Exception $e) {
            DB::rollBack();
